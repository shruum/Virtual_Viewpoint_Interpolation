...
% performs cumulative histogram mapping that maps the luminance/color of im2 to im1
...
edges{1} = [16-0.5:1:235+0.5];   
edges{2} = [16-0.5:1:240+0.5];   
edges{3} = [16-0.5:1:240+0.5];  
